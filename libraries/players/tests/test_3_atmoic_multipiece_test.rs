...
mod atomic_multipiece_test {
    ...
    fn all_pieces_at_same_place_test() {
        ...
        player.join_piece(1, 0, 6);
        player.join_piece(2, 0, 6);
        player.join_piece(3, 0, 6);
